...
class Gaym():
    ...
    def rectangle(self):
        self.__side1 = random.randint(1,1000)
        self.__side2 = random.randint(1,1000)
    ...
    def triangle(self):
        self.__perimeter = random.randrange(12,1000,12)
        self.hp = self.__perimeter / 2
        self.__side1 = random.randrange(self.__perimeter / 3,self.hp - 2,2)
        self.__side2 = random.randrange(self.__perimeter / 3,self.hp - 2,2)
    ...
    def circle(self):
        self.__radius = random.randint(1, 666)
    ...
    def quadrat(self):
        self.__side1 = random.randint(1,616)
